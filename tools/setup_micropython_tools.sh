...
MICROPYTHON_LIBRARY_FILES=(
  "lib/drivers/boolpalette.py|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/boolpalette.py"
  "lib/drivers/st7735r/package.json|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/st7735r/package.json"
  "lib/drivers/st7735r/st7735r.py|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/st7735r/st7735r.py"
  "lib/drivers/st7735r/st7735r_4bit.py|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/st7735r/st7735r_4bit.py"
  "lib/drivers/st7735r/st7735r144.py|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/st7735r/st7735r144.py"
  "lib/drivers/st7735r/st7735r144_4bit.py|https://raw.githubusercontent.com/peterhinch/micropython-nano-gui/master/drivers/st7735r/st7735r144_4bit.py"
...
Downloaded files are placed under tools/.local/, which is ignored by Git.
USAGE
}
...
This directory is generated by tools/setup_micropython_tools.sh.
...
Upload MicroPython libraries:
  ${mpremote_cmd} connect ${connect_arg} fs mkdir :lib
  ${mpremote_cmd} connect ${connect_arg} fs cp -r ${LIB_DIR}/drivers :lib/
EOF
  else
    cat <<EOF

MicroPython libraries were not downloaded. Re-run without --skip-libraries
before uploading the AIPI-Lite application source.
EOF
  fi
...
main() {
  ...
  mkdir -p "${TOOLS_ROOT}" "${DOWNLOAD_DIR}" "${LIB_ROOT}"
