...
| `main.py` | Application entrypoint. It prints bring-up status, renders the boot screen when available, enters offline status if the configured network is unavailable, and polls GPIO42 for reconnect or push-to-talk input. |
