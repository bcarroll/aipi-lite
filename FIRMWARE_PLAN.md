...
| --- | --- | --- |
| Flashing support | Implemented for backup/recovery milestone | `install.sh`, `RECOVERY.md`, `tools/setup_micropython_tools.sh`, `tools/README.md`, and `README.md` document and automate exact-size adaptive stock backup, MicroPython install, source upload, and stock restore using ignored local artifacts. |
